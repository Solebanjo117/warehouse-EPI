...
namespace WarehouseEPI.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910154113_ProcessWipAssignments")]
    partial class ProcessWipAssignments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WarehouseEPI.Core.Entities.ProductionProcessWipTarget", b =>
                {
                    ...
                    b.HasIndex("ProductionStageId", "RowCode", "RackNumber")
                        .IsUnique()
                        .HasFilter("row_code IS NOT NULL");

                    b.ToTable("production_process_wip_targets", null, t =>
                        {
                            t.HasCheckConstraint("ck_production_process_wip_targets_shape", "(location_id IS NOT NULL AND row_code IS NULL AND rack_number IS NULL) OR (location_id IS NULL AND row_code IS NOT NULL AND rack_number IS NOT NULL)");
                        });
                });
