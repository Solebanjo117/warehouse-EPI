...
public static class ProductionDailyText
{
    ...
    private static readonly string[] Keys = [
        ...
        "La fecha debe estar dentro de la semana seleccionada (lunes a domingo).",
        ...
        "La fecha del programa no corresponde a lunes-domingo de la hoja.",
        "La cantidad programada debe ser positiva.",
        "La fecha de ejecución no corresponde a lunes-domingo de la hoja.",
