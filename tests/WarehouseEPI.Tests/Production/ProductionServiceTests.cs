...
public sealed class ProductionServiceTests
{
    ...
    {
        private const string Key = "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8="; public string AdminPin { get; }
        public string OperatorPin { get; }
        public WarehouseDbContext Db { get; }
        public ProductionService Service { get; }
        public Product Product { get; private set; } = null!; public ProductionShift Shift { get; private set; } = null!; public Location Location { get; private set; } = null!;
