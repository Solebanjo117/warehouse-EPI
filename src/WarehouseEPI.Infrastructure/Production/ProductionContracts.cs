...
public sealed record ReceiveProductionToWarehouseCommand(Guid OperationId, Guid WorkOrderId, Guid FinalStageId, decimal Quantity, Guid DestinationLocationId, string Pin, IReadOnlyCollection<SharedAssignmentApproval>? ApprovedSharedAssignments = null, Guid? BatchId = null, uint? ExpectedVersion = null, [property: System.Text.Json.Serialization.JsonIgnore(Condition = System.Text.Json.Serialization.JsonIgnoreCondition.WhenWritingNull)] IReadOnlyList<decimal>? PalletQuantities = null);
public sealed record ProductionStageProgress(Guid Id, int Sequence, string Code, string Name, decimal AvailableInput, decimal Processed, decimal Good, decimal Rework, decimal Scrap, decimal AvailableToDeliver, decimal Delivered, decimal Received, decimal PendingReceipt, DateTimeOffset? InputSince = null, DateTimeOffset? GoodSince = null);
...
public sealed record ProductionOrderRow(Guid Id, string Number, string? ExternalReference, string Sku, string? Description,
    ...
    string? ActiveProcess = null, int AlertCount = 0, bool UsesBatchTraceability = false, ProductionSupplyPriority Priority = ProductionSupplyPriority.Normal, string? Attention = null, string? NextAction = null);
public sealed record ProductionOrderSearch(string? Search = null, ProductionWorkOrderStatus? Status = null, Guid? ActiveStageId = null,
    DateOnly? From = null, DateOnly? To = null, bool AlertsOnly = false, int Page = 1, int PageSize = 25, string View = "all");
