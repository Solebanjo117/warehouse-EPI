...
public sealed record ProductionHandoffCommand(Guid OperationId, Guid WorkOrderId, Guid SourceStageId, Guid TargetStageId, decimal Quantity, string Pin, string? Reason = null);
public sealed record ReceiveProductionToWarehouseCommand(Guid OperationId, Guid WorkOrderId, Guid FinalStageId, decimal Quantity, Guid DestinationLocationId, string Pin, IReadOnlyCollection<SharedAssignmentApproval>? ApprovedSharedAssignments = null);
